...
/* added: the mmp options */
#define WRAPFS_MMAP "mmap"
#define WRAPFS_NOMMAP NULL

/*added: for logging purposes*/
#define ERR printk("KERN_ERR [%d]%s: %s\n", __LINE__, __FILE__, __func__)
#define LOGINT(value) printk("KERN_INFO [%d]%s: %s : [%d]\n", __LINE__, __FILE__, __func__, value)
#define LOGMSG(msg) printk("KERN_INFO [%d]%s: %s : [%s]\n", __LINE__, __FILE__, __func__, msg)
...
/* added: begin New File Operations */
...
/* 
 *added: sb_mmap to indicate the presence of mmap option
